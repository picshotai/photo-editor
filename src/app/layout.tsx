...
export const metadata: Metadata = {
  ...
  description:
    "Transform your photos with AI-powered style transfer in seconds. Choose from prompt-based styles including anime, oil painting, cyberpunk, and more. Powered by fal.ai's fast AI infrastructure.",
  keywords: [
    "AI style transfer",
  ...
  openGraph: {
    ...
    description:
      "Transform your photos with AI-powered style transfer in seconds. Choose from prompt-based styles.",
